...
def count_failed_students(student_scores):
    ...
    non_passing_students = [score for score in student_scores if score <= 40]
    return len(non_passing_students)
...
def letter_grades(highest):
    ...
    """
    grade = (highest - 40) // 4
    return [step for step in range(41, highest, grade)] 
...
def student_ranking(student_scores, student_names):
    ...
    """
    return [str(index+1)+". "+student_names[index]+": "+str(student_scores[index]) for index in range(0,len(student_scores)) ] 
...
def perfect_score(student_info):
    ...
    """
    first = [[student,score] for student, score in student_info if score == 100]
